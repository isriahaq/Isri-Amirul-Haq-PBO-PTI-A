...
public class Main {
    public static void main(String[] args) {
        ...
        Manusia perempuanMenikah = new Manusia("Sasuke", false, "987654321", true);
        Manusia belumMenikah = new Manusia("Sakura", true, "456789123", false);
        ...
        MahasiswaFILKOM mahasiswa1 = new MahasiswaFILKOM("Shikamaru", false, "165150600000001", false, "165150600000001", 2.8);
        MahasiswaFILKOM mahasiswa2 = new MahasiswaFILKOM("Choji", true, "165150600000002", false, "165150600000002", 3.2);
        MahasiswaFILKOM mahasiswa3 = new MahasiswaFILKOM("Ino", true, "165150600000003", false, "165150600000003", 3.7);
        ...
        Pekerja pekerja1 = new Pekerja("Hinata", true, "456123789", true, 5000, LocalDate.of(2019, 5, 1), 2);
        Pekerja pekerja2 = new Pekerja("Shino", false, "789123456", true, 6000, LocalDate.of(2013, 9, 12), 0);
